  ...
  (parser
   ...
   (grammar
    ...
    (program
     ...
     ((program external-declaration) (stx:program (append (stx:program-stmts $1) `(,$2)))))
    ;; 大域宣言
    (external-declaration
     ; <declaration>
     ((declaration) $1)
    ...
    (declaration-list
     ...
     ((declaration-list declaration) (stx:cmpd-stmt (append (stx:cmpd-stmt-stmts $1) `(,$2)))))
    ;; 文のリストのオプショナル
    (statement-list-opt
     ;
     (() (stx:cmpd-stmt '()))
    ...
    (statement-list
     ; <statement>
     ((statement) (stx:cmpd-stmt (if (list? $1) `(,@$1) `(,$1))))
     ; <statement-list> <statement>
     ((statement-list statement)
      (stx:cmpd-stmt (if (list? $2)
